...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTileENDCLASS_t qt_meta_stringdata_CLASSTileENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 10),  // "ToggleFlag"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 5),  // "Tile*"
        QT_MOC_LITERAL(23, 1),  // "t"
        QT_MOC_LITERAL(25, 8)   // "MineTile"
    },
    "Tile",
    "ToggleFlag",
    "",
...
void Tile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ToggleFlag((*reinterpret_cast< std::add_pointer_t<Tile*>>(_a[1]))); break;
        case 1: _t->MineTile((*reinterpret_cast< std::add_pointer_t<Tile*>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Tile::*)(Tile * );
            if (_t _q_method = &Tile::ToggleFlag; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Tile::*)(Tile * );
            if (_t _q_method = &Tile::MineTile; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
